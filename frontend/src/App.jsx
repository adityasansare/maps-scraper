...
function App() {
  ...
  const handleScrape = async () => {
    ...
    try {
      const res = await fetch("https://maps-scraper-backend-cu7k.onrender.com/scrape", {
        method: "POST",
  ...
  const downloadCSV = async () => {
    try {
      const res = await fetch("https://maps-scraper-backend-cu7k.onrender.com/download_csv");
